...
data Val = VNil
         ...
         | VTuple [Val] | VLam [String] Exp (Env Val)
...
evalProg :: Program -> Error Val
evalProg (Program decls e) =  Error "evalProg not implemented, your assignment 5. Define evalDecls in where to help."
